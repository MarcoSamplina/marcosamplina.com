  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative">
      ...
      {active !== null && (
        ...
        >
          {active === item && (
            <div className="absolute top-[calc(100%_+_0.75rem)] left-1/2 -translate-x-1/2 pt-2">
              <motion.div
                transition={transition}
                layoutId="active"
                className="backdrop-blur-sm rounded-2xl overflow-hidden border border-white/[0.15] bg-zinc-900/95 shadow-xl"
              >
                <motion.div
